...
## Таблица кодов ошибок протокола CCNET
...
> **Примечание:**
> В зависимости от модели и прошивки купюроприёмника, список кодов может отличаться. Для вашей модели MSM-3024 полный список приведён выше. При появлении любого из этих кодов купюроприёмник требует вмешательства для восстановления работы.
